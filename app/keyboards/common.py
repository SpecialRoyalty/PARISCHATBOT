...
def role_choice(is_super=False, is_admin=False, is_trusted=False):
    ...
    if is_trusted or is_admin or is_super: rows.append([('🤝 Panel Trusted','nav:trusted')])
