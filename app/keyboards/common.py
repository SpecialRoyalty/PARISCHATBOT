...
def trusted_panel():
    return kb([[('➕ Proposer un match','trusted:propose')],[('➕ Ajouter un mot interdit','trusted:add_word')],[('⚔ Commandes Trusted','trusted:commands')],[('👤 Panel utilisateur','nav:user')]])
